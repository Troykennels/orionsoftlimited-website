// Frontend mirror of api/_lib/richtext.js — same minimal, safe parser for
// document template bodies (allow-listed tags only: b/strong, i/em, br,
// p/div, ul/ol/li). Kept in sync manually since api/ and src/ build/ship
// separately; used by the public signing page so formatting shows correctly
// instead of leaking literal tags.
